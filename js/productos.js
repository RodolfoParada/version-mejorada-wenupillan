...
const productos = [
  ...
  { id: 2, nombre: 'Toki Irish Red Ale 6.5', precio: 12000,  imagen: '/assets/productos/cerveza-machi.jpg', texto: 'Precio exclusivo por pack de 4 unidades', info:'Toqui es una cerveza de estilo Irish Red Ale de color cobrizo con aroma a maltas caramelo, maltas tostadas y lúpulo. Sabor herbal de cuerpo medio bajo y un toque de amargor moderado. Sin aditivos, ni preservantes. Sin Filtrar.' },
  { id: 3, nombre: 'Weichafe IPA 7.2', precio: 12000,  imagen: '/assets/productos/cerveza-lonko.jpg', texto: 'Precio exclusivo por pack de 4 unidades',info:'Weichafe es una cerveza IPA (Indian Pale Ale) de color oro. Aroma a maltas y lúpulo. Sabor fuertemente lupulado y equilibrado con malta. Sin aditivos, ni preservantes. Sin Filtrar.' },
